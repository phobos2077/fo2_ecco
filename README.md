...
- become a trapper by luring some animals into your traps using food as bait!

**Combat**:
- rebalanced weapons and adjusted their distribution to make most of them have good use cases
- several new guns to "fill" certain voids and give you more choice
- new weapon features for more interesting weapon selection: burst accuracy, energy cell cost per shot, melee range hit chance penalty, etc.
- ammo types matter with more to choose from and AP made useful thanks to improved damage formula (some can even change weapon damage type!)
...
- stealing system is reworked to be more fair and encourage skill progression
- using drugs on NPC's require to pass skill checks to succeed
